...
Activity 1 commit ID: __________________________
...
```text
cd ..
git clone GITHUB_REPOSITORY_URL CSC350_Git_Story_Lab_partner
cd CSC350_Git_Story_Lab_partner
```
...
Partner’s Activity 1 commit ID: __________________________
...
Author’s new commit ID: __________________________
...
Partner’s new commit ID: __________________________
